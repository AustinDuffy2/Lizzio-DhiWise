import 'package:spikeai/widgets/app_bar/custom_app_bar.dart';import 'package:spikeai/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:spikeai/widgets/app_bar/appbar_subtitle.dart';import 'package:spikeai/widgets/app_bar/appbar_trailing_iconbutton_three.dart';import 'package:spikeai/widgets/custom_search_view.dart';import '../result_filter_screen/widgets/filter_item_widget.dart';import 'widgets/layout1_item_widget.dart';import 'package:flutter/material.dart';import 'package:spikeai/core/app_export.dart';import 'package:spikeai/presentation/filter_full_bottomsheet/filter_full_bottomsheet.dart';
// ignore_for_file: must_be_immutable
class ResultFilterScreen extends StatelessWidget {ResultFilterScreen({Key? key}) : super(key: key);

TextEditingController searchController = TextEditingController();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 10.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(height: 7.v), CustomSearchView(controller: searchController, hintText: "Modern House"), SizedBox(height: 20.v), _buildItemHeader(context), SizedBox(height: 20.v), _buildFilter(context), SizedBox(height: 20.v), _buildLayout(context)])))); } 
/// Section Widget
