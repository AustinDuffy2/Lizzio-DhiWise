import 'package:spikeai/widgets/app_bar/custom_app_bar.dart';import 'package:spikeai/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:spikeai/widgets/custom_text_form_field.dart';import 'package:spikeai/widgets/custom_elevated_button.dart';import 'package:flutter/material.dart';import 'package:spikeai/core/app_export.dart';
...
@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(context), body: SizedBox(width: SizeUtils.width, child: SingleChildScrollView(padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom), child: Form(key: _formKey, child: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 50.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Let’s Sign In 👇 ", style: theme.textTheme.headlineSmall), SizedBox(height: 30.v), Text("quis nostrud exercitation ullamco laboris nisi ut", style: theme.textTheme.bodyMedium), SizedBox(height: 50.v), _buildEmail(context), SizedBox(height: 15.v), _buildPassword(context), SizedBox(height: 12.v), _buildForgotPasswordRow(context), SizedBox(height: 35.v), _buildLoginButton(context), SizedBox(height: 18.v), _buildItemSeparatorStack(context), SizedBox(height: 18.v), _buildGoogleRow(context), SizedBox(height: 5.v)]))))), bottomNavigationBar: _buildSeventySevenRow(context))); } 
/// Section Widget
...
/// Section Widget
Widget _buildForgotPasswordRow(BuildContext context) { return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text("Forgot password?", style: CustomTextStyles.titleSmallPrimary), Text("Show password", style: CustomTextStyles.titleSmallMedium)]); } 
/// Section Widget
Widget _buildLoginButton(BuildContext context) { return CustomElevatedButton(text: "Login"); } 
/// Section Widget
