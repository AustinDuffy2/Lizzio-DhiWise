import 'package:spikeai/widgets/app_bar/custom_app_bar.dart';import 'package:spikeai/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:spikeai/widgets/app_bar/appbar_trailing_iconbutton_two.dart';import 'package:spikeai/presentation/messages_list_page/messages_list_page.dart';import 'package:flutter/material.dart';import 'package:spikeai/core/app_export.dart';class NotificationListTabContainerScreen extends StatefulWidget {const NotificationListTabContainerScreen({Key? key}) : super(key: key);
...
@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: SizedBox(width: double.maxFinite, child: Column(children: [SizedBox(height: 17.v), _buildTabview(context), Expanded(child: SizedBox(height: 690.v, child: TabBarView(controller: tabviewController, children: [MessagesListPage(), MessagesListPage()])))])))); } 
/// Section Widget
