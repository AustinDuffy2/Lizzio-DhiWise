import 'widgets/promotionbanner_item_widget.dart';import 'widgets/layout13_item_widget.dart';import 'widgets/layout14_item_widget.dart';import 'widgets/layout15_item_widget.dart';import 'widgets/home_item_widget.dart';import 'package:flutter/material.dart';import 'package:spikeai/core/app_export.dart';class HomePage extends StatefulWidget {const HomePage({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildLayout(BuildContext context) { return SizedBox(height: 156.v, child: ListView.separated(scrollDirection: Axis.horizontal, separatorBuilder: (context, index) {return SizedBox(width: 10.h);}, itemCount: 2, itemBuilder: (context, index) {return Layout13ItemWidget();})); } 
/// Section Widget
...
/// Section Widget
Widget _buildLayout1(BuildContext context) { return SizedBox(height: 56.v, child: ListView.separated(scrollDirection: Axis.horizontal, separatorBuilder: (context, index) {return SizedBox(width: 4.h);}, itemCount: 4, itemBuilder: (context, index) {return Layout14ItemWidget();})); } 
/// Section Widget
...
/// Section Widget
Widget _buildLayout2(BuildContext context) { return SizedBox(height: 96.v, child: ListView.separated(scrollDirection: Axis.horizontal, separatorBuilder: (context, index) {return SizedBox(width: 15.h);}, itemCount: 5, itemBuilder: (context, index) {return Layout15ItemWidget();})); } 
/// Section Widget
